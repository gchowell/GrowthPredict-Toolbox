...
| `parameters-GrowthModel-… .mat` *(if saved)* | Fit / Forecast                                                          | MATLAB snapshot for downstream use.                                             | Model choice, parameter draws, bootstrap artifacts, run settings.                  |
| `Forecast-… .mat` *(if saved)*               | **Forecast**                                                            | Forecast draws & summaries.                                                     | Forecast paths, quantiles, horizon metadata.                                       |
